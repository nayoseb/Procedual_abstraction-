...
//                };
    ...
    private static void potionTestWithInfiniteIterators() {
         ...
         * 끝없는 이어지는 데이터를 순열(스트림)로 간추리는 기법은 시계열 데이터 시뮬레이션을 다루는 데 잘 들어맞습니다. 이를 테면,이동 통신 환경에서 통신망 저편에서
         * 끝없이 흘러 들어오는 수백 개의 센서 데이터 스트림을 떠올려 보면 어렵지 않게 끝없는 데이터 순열을 떠올릴 수 있습니다.
         *
